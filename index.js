	...
	render() {
		...
		return (
			<View style={[styles.reactangle,{height:width+borderWidth,width:width+borderWidth}]}>
				<View style={[styles.percentViewBar,
						{ top: 0, left: 0, height: borderWidth, width: percent >= 25 ? width : width * (percent * 4 / 100) }]}/>
				<View style={[styles.percentViewBar,{ top: 0, right: 0, height: percent >= 50 ? width : width * ((percent - 25) * 4 / 100), width: borderWidth }]}/>
				...
				<View style={[ styles.percentViewBar, {bottom: 0,left: 0,height: percent === 100 ? width : width * ((percent - 75) * 4 / 100),width: borderWidth} ]} />
				<View style={[styles.percentViewBar, { bottom: 0, right: 0, height: borderWidth, width: percent >= 75 ? width : width * ((percent - 50) * 4 / 100)}]}/>
			</View>
		);
	}
}
